...
Dim Shared As String cPool (767)
Dim Shared As uByte tMaps (767, 255)
...
Function findPatternInPoolAndAdd (patternS As String, ByRef wasNew As Integer) As Integer
	...
	For i = 0 To cPoolIndex - 1
		If cPool (i) = patternS Then
			If debug Then fiPuts "Existing pattern, index: " & i
	...
	wasNew = -1
	If debug Then fiPuts "New pattern, index: " & cPoolIndex
