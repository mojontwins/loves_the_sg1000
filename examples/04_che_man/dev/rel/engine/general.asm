...
; This file was generated Wed Sep 11 14:35:17 2019
;--------------------------------------------------------
	.module general
	.optsdcc -mz80
...
00105$:
	...
	ld	l, a
	ret
;./engine/general.c:74: void run_fire_script (void) {
;	---------------------------------
; Function run_fire_script
; ---------------------------------
_run_fire_script::
;./engine/general.c:75: fire_script_success = 0;
	ld	hl,#_fire_script_success + 0
	ld	(hl), #0x00
;./engine/general.c:76: run_script (2 * MAP_SIZE + 2);
	ld	a,#0x2A
	push	af
	inc	sp
	call	_run_script
	inc	sp
;./engine/general.c:77: run_script ((n_pant << 1) + 1);
	ld	a,(#_n_pant + 0)
	add	a, a
	inc	a
	push	af
