...
; This file was generated Wed Sep 11 15:04:45 2019
;--------------------------------------------------------
	.module printer
	.optsdcc -mz80
...
00120$:
	...
	or	a, a
	jr	Z,00122$
;./engine/../engine/mapmods/../../my/map_renderer_customization.h:12: rda = map_buff [gpit]; 
	ld	hl,(_gpit)
	ld	h,#0x00
	add	hl,bc
	ld	a,(hl)
	ld	(#_rda + 0),a
;./engine/../engine/mapmods/../../my/map_renderer_customization.h:13: rdb = rand8 () & 1;	
	push	bc
	call	_rand8
	ld	a,l
	pop	bc
	and	a, #0x01
	ld	(#_rdb + 0),a
;./engine/../engine/mapmods/../../my/map_renderer_customization.h:14: if (level < 3) {
	ld	a,(#_level + 0)
	sub	a, #0x03
	jr	NC,00118$
;./engine/../engine/mapmods/../../my/map_renderer_customization.h:15: if (rdb && rda < 15) rda += 16;
	ld	a,(#_rdb + 0)
	or	a, a
	jr	Z,00119$
	ld	a,(#_rda + 0)
	...
	jr	00119$
00118$:
;./engine/../engine/mapmods/../../my/map_renderer_customization.h:17: switch (rda) {
	ld	a,(#_rda + 0)
	cp	a,#0x03
	jr	Z,00110$
	sub	a, #0x0D
	jr	Z,00113$
	jr	00119$
;./engine/../engine/mapmods/../../my/map_renderer_customization.h:18: case 3: if (rdb) rda = 4; break;
00110$:
	ld	a,(#_rdb + 0)
	or	a, a
	jr	Z,00119$
	...
	ld	(hl), #0x04
	jr	00119$
;./engine/../engine/mapmods/../../my/map_renderer_customization.h:19: case 13: if (map_buff [gpit - 16] != 13) rda = 14; break;
00113$:
	ld	a,(#_gpit + 0)
	ld	h, #0x00
	add	a,#0xF0
	...
	ld	hl,#_rda + 0
	ld	(hl), #0x0E
;./engine/../engine/mapmods/../../my/map_renderer_customization.h:20: }
00119$:
;./engine/../engine/mapmods/../../my/map_renderer_customization.h:23: map_buff [gpit] = rda;
	ld	hl,(_gpit)
	ld	h,#0x00
	add	hl,bc
	ld	a,(#_rda + 0)
...
;./engine/../engine/mapmods/map_renderer_complex.h:165: rdt = *gp_ram ++;
	...
	inc	(hl)
00282$:
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:45: if (rdt >= CHAC_CHAC_DETECT_TILE && rdt <= CHAC_CHAC_DETECT_TILE + CHAC_CHAC_DETECT_TILES-1) {
	ld	a,(#_rdt + 0)
	sub	a, #0x27
	jr	C,00142$
	ld	a,#0x29
	...
	sub	a, 0 (iy)
	jr	C,00142$
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:46: chac_chacs_add ();
	push	bc
	call	_chac_chacs_add
	pop	bc
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:48: rdt = map_buff [rdm] = 0;
	ld	hl,(_rdm)
	ld	h,#0x00
	add	hl,bc
	ld	(hl),#0x00
