...
; This file was generated Wed Sep 11 15:07:30 2019
;--------------------------------------------------------
	.module enengine
	.optsdcc -mz80
...
;./engine/enengine.c:107: en_state [gpit] = _en_state;
	...
	ld	a,(#__en_state + 0)
	ld	(hl),a
;./engine/enengine.c:110: enf_x [gpit] = _enf_x; enf_vx [gpit] = _enf_vx;
	ld	iy,#_gpit
	ld	l,0 (iy)
	ld	h,#0x00
	add	hl, hl
	...
	ld	a,(#__enf_vx + 1)
	ld	(hl),a
;./engine/enengine.c:111: enf_y [gpit] = _enf_y; enf_vy [gpit] = _enf_vy;
	ld	iy,#_gpit
	ld	l,0 (iy)
	ld	h,#0x00
	add	hl, hl
...
;./engine/enengine.c:155: gp_gen += 4;
	...
	adc	a, #0x00
	ld	(hl),a
;./engine/enengine.c:158: rda = VDPDataPort;
	in	a,(_VDPDataPort)
	ld	(#_rda + 0),a
;./engine/enengine.c:159: rdb = VDPDataPort;
	in	a,(_VDPDataPort)
	ld	(#_rdb + 0),a
;./engine/enengine.c:160: rdm = VDPDataPort;
	in	a,(_VDPDataPort)
	ld	(#_rdm + 0),a
;./engine/enengine.c:161: rdt = VDPDataPort;
	in	a,(_VDPDataPort)
	ld	(#_rdt + 0),a
	jp	00116$
00115$:
...
;./engine/enengine.c:247: break;
	jr	00113$
;./engine/enengine.c:264: case 6:
00112$:
;./engine/enengine.c:266: enems_init_fp ();
	push	bc
	call	_enems_init_fp
	pop	bc
;./engine/enengine.c:267: _enf_vx = _enf_vy = 0;
	ld	hl,#0x0000
	ld	(__enf_vy),hl
	ld	l, #0x00
	ld	(__enf_vx),hl
;./engine/enengine.c:272: _en_s = FANTY_BASE_SPRID;
	ld	hl,#__en_s + 0
	ld	(hl), #0x20
...
;./engine/enengine.c:487: _en_state = en_state [gpit];
	...
	ld	a,(de)
	ld	(#__en_state + 0),a
;./engine/enengine.c:490: _enf_x = enf_x [gpit]; _enf_vx = enf_vx [gpit];
	ld	iy,#_gpit
	ld	l,0 (iy)
	ld	h,#0x00
	add	hl, hl
	...
	ld	a,(hl)
	ld	(#__enf_vx + 1),a
;./engine/enengine.c:491: _enf_y = enf_y [gpit]; _enf_vy = enf_vy [gpit];
	ld	hl,#_enf_y
	add	hl,de
	ld	a,(hl)
	ld	iy,#__enf_y
...
00242$:
	...
	ld	a,-2 (ix)
	ld	(#_en_fr + 0),a
;./engine/enengine.c:554: if (res_on 
	ld	a,(#_res_on + 0)
	or	a, a
	jr	Z,00172$
;./engine/enengine.c:567: ) {
	ld	a,(#__en_t + 0)
	sub	a, #0x04
	jr	Z,00172$
;./engine/enengine.c:568: en_spr = en_spr_id [gpit];
	ld	a,#<(_en_spr_id)
	ld	hl,#_gpit
	add	a, (hl)
	ld	e,a
...
00613$:
	jp	P,00216$
;./engine/enengine.c:793: if (res_on || res_disable)
	ld	a,(#_res_on + 0)
	or	a, a
	jr	NZ,00196$
	ld	a,(#_res_disable + 0)
...
00617$:
	ld	(#_en_sg_2 + 0),a
;./engine/enengine.c:848: ) en_sg_2 = 0;
	ld	a,(#_res_on + 0)
	dec	a
	jr	NZ,00207$
	ld	hl,#_en_sg_2 + 0
	ld	(hl), #0x00
00207$:
;./engine/enengine.c:874: if (en_sg_1) enems_hit ();
	ld	a,(#_en_sg_1 + 0)
	or	a, a
	jr	Z,00209$
	call	_enems_hit
