...
const unsigned char l_scr_ini [] = 				{ 28, 28, 28, 12 };
const unsigned char l_ini_x [] = 				{ 5, 5, 5, 5 };
const unsigned char l_ini_y [] = 				{ 6, 7, 6, 6 };
const unsigned char l_map_w [] = 				{ 7, 7, 7, 4 };
const unsigned char l_map_h [] =				{ 5, 5, 5, 4 };
...
const unsigned char * const * const l_spr_enems [] =
												{ spr_enems0, spr_enems1, spr_enems1, spr_enems0 };
...
// Map data
	...
	const unsigned char * const * const l_map [] =	
		...
		const unsigned char l_decos [] = 		{ 0, 1, 1, 1 };												
	#endif
#endif
...
const unsigned char * const l_music [] = 		{ MUSIC_INGAME1, MUSIC_INGAME2, MUSIC_INGAME3, MUSIC_INGAME2 };
