...
const unsigned char l_scr_ini [] = 				{ 28, 28, 28 };
const unsigned char l_ini_x [] = 				{ 5, 5, 5 };
const unsigned char l_ini_y [] = 				{ 6, 7, 6 };
const unsigned char l_map_w [] = 				{ 7, 7, 7 };
const unsigned char l_map_h [] =				{ 5, 5, 5 };
...
const unsigned char * const * const l_spr_enems [] =
												{ spr_enems0, spr_enems1, spr_enems1 };
