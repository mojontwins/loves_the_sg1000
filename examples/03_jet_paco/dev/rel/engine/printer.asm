...
;./engine/../engine/mapmods/map_renderer_complex.h:165: rdt = *gp_ram ++;
	...
	inc	(hl)
00231$:
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:13: if (rdt == PROPELLER_TILE && propellers_on) {
	ld	a,(#_rdt + 0)
	sub	a, #0x10
	jr	NZ,00126$
	...
	or	a, a
	jr	Z,00126$
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:14: propellers_add ();
	push	bc
	call	_propellers_add
	pop	bc
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:15: rda = rdm; 
	ld	a,(#_rdm + 0)
	ld	(#_rda + 0),a
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:17: rdc = PROPELLERS_MAX_LENGTH;
	ld	hl,#_rdc + 0
	ld	(hl), #0x06
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:18: while (rda >= 16 && rdc --)
00122$:
	ld	a,(#_rda + 0)
	sub	a, #0x10
	jr	C,00126$
	...
	or	a, a
	jr	Z,00126$
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:23: rda -= 16;
	ld	hl,#_rda
	ld	a,(hl)
	add	a,#0xF0
	ld	(hl),a
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:25: if (c_behs [map_buff [rda]]) break; else {
	ld	a,(#_rda + 0)
	add	a, c
	ld	e,a
	ld	a,#0x00
	...
	or	a, a
	jr	NZ,00126$
;./engine/../engine/mapmods/../../engine/mapmods/map_detectors.h:26: map_buff [rda] = PROPELLER_FLOATABLE_TILE;
	ld	a,#0x11
	ld	(de),a
	jr	00122$
00126$:
